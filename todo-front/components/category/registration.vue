      ...
      <tbody>
        <tr>
          ...
          <th class="create-form__table__th__register" rowspan="2">
            <div class="create-form__button">
              <button 
                ref="submit_button" 
                class="create-form__button-submit" 
                type="button"
                @click="storeCategory(newCategory)" 
        ...
        <tr>
          <td class="create-form__table__td">
            <input v-model="newCategory" class="create-form__item__input" type="text" name="カテゴリ" placeholder="新しいカテゴリを入力してください" />
          </td>
        </tr>
        <tr>
          <td class="create-form__table__td">
