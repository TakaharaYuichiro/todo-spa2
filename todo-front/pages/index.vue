<template>
  <div class="container">
    ...
    <HomeRegistration @trigger-registration="eventRegistrationComponent" :categories="categories"
      :currentUserInfo="currentUserInfo" />

    <div class="listContainer">
      <HomeSearch @trigger-search="eventSearchComponent" :categories="categories" :users="users" />
      <HomeEditor @trigger-editor="eventRegistrationComponent" ref="editorRef" :todos="todos" :categories="categories"
        :users="users" :currentUserInfo="currentUserInfo" />
    </div>
  </div>
</template>
